...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(preferences.getBoolean("loggedin",false)){
            ...
            i.putExtra("uora",preferences.getString("uora",null));
            startActivity(i);
            finish();
        }
...
*/
            ...
            if(response.equals("invalid")){
            ...
            else if(response.equals("successu")||response.equals("successa")){
                ...
                if(response.equals("successu")) {
                    i.putExtra("uora", "u");
                    preferences.edit().putString("uora","u").apply();
                }
                else {
                    i.putExtra("uora","a");
                    preferences.edit().putString("uora","a").apply();
                }
